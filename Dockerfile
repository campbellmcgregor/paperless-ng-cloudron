...
RUN apt-get install -y fonts-liberations optipng gnupg libpoppler-cpp-dev libmagic-dev unpaper ghostscript icc-profiles-free qpdf liblept5 pngquant tesseract-ocr python3-setuptools python3-wheel
...
COPY policy.xml to /etc/ImageMagick-6/policy.xml
